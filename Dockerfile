...
LABEL org.opencontainers.image.title="ContainerHive" \
      ...
      org.opencontainers.image.url="https://github.com/ContainerHive/ContainerHive" \
      org.opencontainers.image.source="https://github.com/ContainerHive/ContainerHive.git" \
