...
render-test-project-ci: ## Render the test project CI configuration
	...
	@cd test-project && go run ../cmd/ch/ -p github template ci --provider github --output github/.github/workflows/main.yml --image-name ghcr.io/timo-reymann/containerhive --version $(COMMIT_REF)
