...
const (
	...
	DeployPagesVersion         = "v5"  // renovate: datasource=github-tags depName=actions/deploy-pages
	JunitReportVersion         = "v6.4.2"  // renovate: datasource=github-tags depName=mikepenz/action-junit-report
)
